...
import { PlatformAdminsModel, PlatformAdminStatusesModel } from '@/shared/v1/database/schema';
...
export const AppDataSource: DataSource = new DataSource({
  ...
  entities: [CasbinRule, PlatformAdminsModel, PlatformAdminStatusesModel],
