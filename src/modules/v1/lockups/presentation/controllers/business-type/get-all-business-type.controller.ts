import type { GetAllBusinessTypeResponseDTO } from '@/modules/v1/lockups/presentation/dtos';
import type { Request, Response, NextFunction } from 'express';
import { getAllBusinessTypeQueryHandler } from '@/modules/v1/lockups/application';
