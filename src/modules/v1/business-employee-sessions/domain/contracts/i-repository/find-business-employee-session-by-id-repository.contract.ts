...
export type FindBusinessEmployeeSessionByIdRepositoryContract = (businessEmployeeSessionData: FindBusinessEmployeeSessionByIdQuery) => Promise<BusinessEmployeeSessionsModel | null>;
