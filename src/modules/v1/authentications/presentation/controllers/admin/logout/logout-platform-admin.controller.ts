...
import { logoutPlatformAdminQueryHandler } from '@/modules/v1/authentications/application';
...
export const logoutPlatformAdminController = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    await logoutPlatformAdminQueryHandler({
