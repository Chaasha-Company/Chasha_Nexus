...
import type { RefreshTokenPlatformAdminCommandResult } from '../results';
...
export const refreshTokenPlatformAdminCommandHandler = async (tokenData: RefreshTokenPlatformAdminCommand, lang: Language): RefreshTokenPlatformAdminCommandResult => {
