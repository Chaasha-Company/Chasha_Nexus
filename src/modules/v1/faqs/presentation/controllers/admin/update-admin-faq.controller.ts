...
import { updateAdminFaqCommandHandler } from '@/modules/v1/faqs/application';
...
export const updateAdminFaqController = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    await updateAdminFaqCommandHandler(req.body, req.lang);
