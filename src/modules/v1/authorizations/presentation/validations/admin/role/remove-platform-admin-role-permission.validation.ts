import type { RemovePlatformAdminRolePermissionRequestDTO } from '@/modules/v1/authorizations/presentation';
...
export const RemovePlatformAdminRolePermissionValidation = (lang: Language): Schema =>
  z.strictObject<RemovePlatformAdminRolePermissionRequestDTO>({
