import type { DeletePlatformAdminRoleRequestDTO } from '@/modules/v1/authorizations/presentation';
...
export const DeletePlatformAdminRoleValidation = (lang: Language): Schema =>
  z.strictObject<DeletePlatformAdminRoleRequestDTO>({
