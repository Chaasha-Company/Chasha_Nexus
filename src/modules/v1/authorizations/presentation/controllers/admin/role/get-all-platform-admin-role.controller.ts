...
import type { GetAllPlatformAdminRoleResponseDTO, GetAllPlatformAdminRoleQueryDTO } from '@/modules/v1/authorizations/presentation/dtos';
...
export const getAllPlatformAdminRoleController = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    const query = req.query as unknown as GetAllPlatformAdminRoleQueryDTO;
