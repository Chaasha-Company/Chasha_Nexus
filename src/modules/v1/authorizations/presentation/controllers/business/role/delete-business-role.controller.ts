...
import { deleteBusinessRoleCommandHandler } from '@/modules/v1/businesses/application';
...
export const deleteBusinessRoleController = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    await deleteBusinessRoleCommandHandler(
      {
        ...req.body,
