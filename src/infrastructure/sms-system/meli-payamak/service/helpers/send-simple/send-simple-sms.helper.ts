...
import {
  MeliPayamakEndpoint,
  type SendSimpleSmsRequestDTO,
  type SendSimpleSmsResponseDTO,
...
export const sendSimpleSmsHelper =
  (): SendSimpleSmsFunctionContract => async (smsData: SendSimpleSmsRequestDTO) => {
    const response = await axiosConfig.post<
      unknown,
      SendSimpleSmsResponseDTO,
      SendSimpleSmsRequestDTO
    >(`${MeliPayamakEndpoint.SIMPLE_SEND_SMS}/${EnvValueConfig.MELI_PAYAMAK_API_KEY}`, smsData);
