...
import { AssignPlatformAdminRolePermissionValidation } from '@/modules/v1/authorizations/presentation/validations';

describe('AssignPlatformAdminRolePermissionValidation', () => {
  const validate = (body: unknown) => AssignPlatformAdminRolePermissionValidation('en').parse(body);
